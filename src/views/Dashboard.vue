<template>
  <div class="animated fadeIn">
    ...
    <b-card>
      <b-row>
        <b-col sm="5">
          <h4 id="traffic" class="card-title mb-0">QweebyBase</h4>
      ...
      <main-chart-example chartId="main-chart-02" class="chart-wrapper" style="height:300px;margin-top:40px;" height="300"></main-chart-example>
      <div slot="footer">
